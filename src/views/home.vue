<template>
  <div class="home-view">
    <layout-box
      title="@springsheep/zp-shepherd-vue"
      description="通过全局挂载的形式使用。"
    >
      <a-button id="driver-btn" type="primary" @click.stop="onOpenDriver"
        >打开新手引导</a-button
      >
    ...
    <layout-box
      title="@springsheep/zp-shepherd-vue"
      description="通过局部导入的方式使用。"
    >
      <a-button id="driver-btn2" type="primary" @click.stop="onOpenDriver2"
        >打开新手引导</a-button
      >
